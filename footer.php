...
<div id="pop-thanks" class="popup popup-small">
  <div class="popup-container">
    <div class="popup-wrapper">
      <div class="close">
        <svg width="14" height="14" viewBox="0 0 14 14" fill="black" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="popup-cont">
        <div class="popup-title-mini">Спасибо!</div>
        <div class="popup-sub-title">Наш менеджер скоро свяжеться с Вами</div>
        <div class="b-btn-ok">
          <a href="#" class="btn">Ок</a>
        </div>
      </div><!--end popup-cont -->
      <div class="pop-qua3"></div>
      <div class="pop-qua7"></div>
    </div><!--end popup-wrapper -->
  </div><!--end popup-container -->
</div><!--end popup -->
