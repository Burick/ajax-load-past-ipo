...
//                }
    ...
    <div class="ip-item">
        <div class="block">
            ...
            <div class="title"><?php echo $value->stock; ?>:<a
            ...
            <div class="props">
                ...
                <div class="p-row"><span>Диапазон цены</span><strong><?php echo $value->offering_range_min; ?>
                        -<?php echo $value->offering_range_max; ?> $</strong></div>
            ...
            <div class="bottom">
                <div class="bott-props">
                    <div class="p-row"><span>Сфера</span><strong
                ...
                <div class="b-timer">
                    ...
                    <div class="timer">
                        <div id="countdown-<?php echo $value->ticker; ?>" class="countdown">
                            ...
                            <div class="countdown-number">
                                <span data="<?php echo preg_replace('~\D+~', '', $ex[2]); ?>"
